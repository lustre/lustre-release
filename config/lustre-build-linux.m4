...
LC_LBUG_WITH_LOC_IN_OBJTOOL
# 5.9
LB_CHECK_CONFIG([DEBUG_INFO_BTF_MODULES],
	[HAVE_DEBUG_INFO_BTF_MODULES="yes"],
	[HAVE_DEBUG_INFO_BTF_MODULES="no"])
])
...
LINUXINCLUDE += -I$LINUX_OBJ/include
LINUXINCLUDE += -I$LINUX_OBJ/include/generated/uapi
LINUXINCLUDE += -I$LINUX_OBJ/arch/$SUBARCH/include/generated
