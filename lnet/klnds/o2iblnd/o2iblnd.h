...
typedef struct
{
	...
	__u64                kib_peers_version; /* peer table version */
...
typedef struct kib_peer
{
	...
	__u32               ibp_conns_version;  /* connection version */
        struct list_head    ibp_conns;          /* all active connections */
        struct list_head    ibp_tx_queue;       /* msgs waiting for a conn */
        __u16               ibp_version;        /* version of peer */
        __u64               ibp_incarnation;    /* incarnation of peer */
        unsigned short	    ibp_connecting;     /* current active connection attempts */
        unsigned short	    ibp_accepting;      /* current passive connection attempts */
