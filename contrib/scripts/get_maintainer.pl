...
#
# Copied from kernel v4.16-11490-gb284d4d5a678
...
my @penguin_chief = ();
push(@penguin_chief, "Oleg Drokin:green\@whamcloud.com");
#push(@penguin_chief, "Andreas Dilger:adilger\@whamcloud.com");
