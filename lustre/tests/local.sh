...
${LMC} --add mds  --node localhost --mds mds1 --fstype ext3 --dev $MDSDEV --size $MDSSIZE || exit 20

# configure ost
${LMC} --add ost --node localhost --obd obd1 --fstype ext3 --dev $OSTDEV --size  $OSTSIZE || exit 30
